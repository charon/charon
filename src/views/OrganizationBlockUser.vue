...
<template>
  ...
  <div class="w-full flex flex-col items-center mt-12 sm:mt-[4.5rem] border-t border-transparent">
    <div class="grid auto-rows-auto grid-cols-[minmax(0,_65ch)] m-1 sm:m-4 gap-1 sm:gap-4">
      <div class="w-full rounded border bg-white p-4 shadow-sm">
      ...
      <div v-if="success" class="w-full rounded border bg-white p-4 shadow-sm">
        <div class="text-success-600">{{ t("views.OrganizationBlockUser.blockingSuccess") }}</div>
      </div>
      <div v-else class="w-full rounded border bg-white p-4 shadow-sm">
