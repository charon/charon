...
<template>
  ...
  <div
    ref="navbar"
    class="z-30 flex min-h-12 w-full grow items-center gap-x-1 border-b border-slate-400 bg-slate-300 p-1 shadow-md will-change-transform sm:gap-x-4 sm:p-4 sm:pl-0"
    v-bind="navbarAttrs"
  >
    <router-link
      id="navbar-link-home"
      :to="{ name: 'Home' }"
      class="group -my-1 -ml-1 self-stretch border-r border-slate-400 p-1.5 outline-none hover:bg-slate-400 active:bg-slate-200 sm:-my-4 sm:ml-0 sm:p-0"
    >
